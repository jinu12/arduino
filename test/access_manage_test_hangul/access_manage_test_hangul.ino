...
LiquidCrystal_I2C_Hangul lcd(0x27, 16, 20); // address, 열, 행
Servo myservo;
void setup() {
...
//  Serial.println(value);
  if(value==1){
    lcd.setDelayTime(100);
    lcd.printHangul(L"사람이접근해있습니다",0,11);
    lcd.setCursor(0,0);
    delay(1000);
  }else{
    lcd.setDelayTime(100);
    lcd.printHangul(L"사람이없습니다",0,11);
    lcd.setCursor(0,0);
    delay(100);
  }
  lcd.clear();
